    ...
    for match in player_matches:
        ...
        for row in match_participants:
            if row['puuid'] == player_uuid:
                ...
                player_position = row['teamPosition']
        ...
        print("Ally 1:{0} Name: {1}\nAlly 2:{2} Name: {3}\nEnemy 1:{4} Name: {5}\nEnemy 2:{6} Name: {7}".format(
            ...
            enemy_champ2_name))
        result_list.append([player_champ_id, player_position, ally_champ1, ally_champ2, enemy_champ1, enemy_champ2])
        print("-----------------------------------------------------------")
    return result_list


list_to_csv = get_match_data('na1', 'americas', 'Doublelift') + get_match_data('na1', 'americas',
                                                                               'Professor Akali') + get_match_data(
    'na1', 'americas', 'Aconko')
print(list_to_csv)
